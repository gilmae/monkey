...
func TestCompilerScopes(t *testing.T) {
	...
	if last.Opcode != code.OpSub {
		t.Errorf("lastInstruction.OpCode wrong. want=%d, got=%d", code.OpSub, last.Opcode)
	}

	if compiler.symbolTable.Outer != globalSymbolTable {
		t.Errorf("compiler did not enclose sybolTable")
	}
	...
	if compiler.symbolTable != globalSymbolTable {
		t.Errorf("compiler did not restore symbol table")
	}
	...
	if last.Opcode != code.OpAdd {
		t.Errorf("lastInstruction.OpCode wrong. want=%d, got=%d", code.OpAdd, last.Opcode)
	}

	previous := compiler.scopes[compiler.scopeIndex].previousInstruction
	if previous.Opcode != code.OpMul {
		t.Errorf("lastInstruction.OpCode wrong. want=%d, got=%d", code.OpMul, last.Opcode)
	}
}
...
func TestFunctionsWithoutReturnBody(t *testing.T) {
	tests := []compilerTestCase{
		{
			input: `fn(){}`,
			expectedConstants: []interface{}{
...
func TestRecusiveFunnctionns(t *testing.T) {
	tests := []compilerTestCase{
		{
			input: `
